...
LongText.args = {
    item: {
        ...
        description: 'Очень длинное описание уведомления, которое должно корректно переноситься и не ломать отображение компонента. Текст может занимать несколько строк.',
    } as Notification,
};
...
SpecialCharacters.args = {
    item: {
        ...
        description: 'Пожалуйста, обновите ваш пароль (используйте A-Z, a-z, 0-9)',
    } as Notification,
};
